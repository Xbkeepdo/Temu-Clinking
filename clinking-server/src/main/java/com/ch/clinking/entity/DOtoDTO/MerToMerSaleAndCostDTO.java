...
public class MerToMerSaleAndCostDTO {

    @Getter
    private static final MerToMerSaleAndCostDTO instance = new MerToMerSaleAndCostDTO();

    public MerSaleAndCostDTO doToDTO(Merchandise merchandise) {
        if (merchandise == null) {
            return null;
        } else {
            MerSaleAndCostDTO dto = new MerSaleAndCostDTO();
