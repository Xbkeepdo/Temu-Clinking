...
@Data
@ToString
public class MerSaleHistoryShopProfitDTO implements Serializable {
    ...
    @TableField(select = false,exist = false)
    private List<SalesHistorySKU> saleInfoList;
    ...
    public List<SalesHistorySKU> getSaleInfoList() {
        return saleInfoList;
    }

    public void setSaleInfoList(List<SalesHistorySKU> saleInfoList) {
    ...
    public String toString() {
        return "MerSaleHistoryShopProfitDTO{" +
                "id=" + id +
                ", shopId='" + shopId + '\'' +
                ", spuId='" + spuId + '\'' +
                ", skcId='" + skcId + '\'' +
