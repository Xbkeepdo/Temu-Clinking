...
@Data
@ToString
public class MerSaleHistorySkuDTO implements Serializable {
    ...
    private List<SalesHistorySKU> salesHistory3Day;

    private List<SalesHistorySKU> salesHistory1Day;
    ...
    public List<SalesHistorySKU> getSalesHistory3Day() {
        return salesHistory3Day;
    }

    public void setSalesHistory3Day(List<SalesHistorySKU> salesHistory3Day) {
        this.salesHistory3Day = salesHistory3Day;
    }

    public List<SalesHistorySKU> getSalesHistory1Day() {
        return salesHistory1Day;
    }

    public void setSalesHistory1Day(List<SalesHistorySKU> salesHistory1Day) {
        this.salesHistory1Day = salesHistory1Day;
    }

    @Override
    public String toString() {
        return "MerSaleHistorySkuDTO{" +
                "id=" + id +
                ", shopId='" + shopId + '\'' +
                ", spuId='" + spuId + '\'' +
                ", skcId='" + skcId + '\'' +
                ...
                ", salesHistory3Day=" + salesHistory3Day +
                ", salesHistory1Day=" + salesHistory1Day +
    ...
    public boolean equals(Object o) {
        ...
        MerSaleHistorySkuDTO that = (MerSaleHistorySkuDTO) o;
