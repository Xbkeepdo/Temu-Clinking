...
public class MerToMerSaleHistorySkuDTO {

    @Getter
    private static final MerToMerSaleHistorySkuDTO instance = new MerToMerSaleHistorySkuDTO();

    public MerSaleHistorySkuDTO doToDTO(Merchandise merchandise) {
        if (merchandise == null) {
            return null;
        } else {
            MerSaleHistorySkuDTO dto = new MerSaleHistorySkuDTO();
