...
public class Merchandise implements Serializable {
    ...
    private List<StockLocations> stockLocations;
    ...
    public List<StockLocations> getStockLocations() {
        return stockLocations;
    }

    public void setStockLocations(List<StockLocations> stockLocations) {
