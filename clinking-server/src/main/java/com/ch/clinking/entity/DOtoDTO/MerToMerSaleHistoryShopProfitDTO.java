...
public class MerToMerSaleHistoryShopProfitDTO {

    @Getter
    private static final MerToMerSaleHistoryShopProfitDTO instance = new MerToMerSaleHistoryShopProfitDTO();

    public MerSaleHistoryShopProfitDTO doToDTO(Merchandise merchandise) {
        if (merchandise == null) {
            return null;
        } else {
            MerSaleHistoryShopProfitDTO dto = new MerSaleHistoryShopProfitDTO();
